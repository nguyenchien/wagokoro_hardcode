...
//	Product at [wagokoro]
//	2018/08/15
//	2018/10/03(print_year_sts Update)(print_ircalender update)
//	2019/01/05(year chenge update)
//	2019/03/20(print_whatsNew_all_hash print_year_sts update)
// *****************************************************************************
// 宣言
	// 銘柄コード
	const DESCRIPTION_CODE = 9271;
	...
	let master_cut_out = ['CG報告書','電子公告','コーポレートG'];		// 予約語（省く文字）

	let url_all = URL_STR_closingSummary;
	url_all = url_all + DESCRIPTION_CODE;
	url_all_4 = url_all + '&type=' + closingSummary_type_4+'&order=year_desc&cyear=5&pageSize=1000';
	url_all_t = url_all + '&type=' + closingSummary_type_consolidated+'&order=year_desc&cyear=5&pageSize=1000';
...
// デフォルトパラメータ
// 売上高
	let salesAmount_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let salesAmount_1Q = ['-','-','-','-','-'];
	let salesAmount_2Q = ['-','-','-','-','-'];
	let salesAmount_3Q = [1801,'-','-','-','-'];
	let salesAmount_4Q = [2488,1732,1286,1027,899];
// 営業利益
	let operatingIncome_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let operatingIncome_1Q = ['-','-','-','-','-'];
	let operatingIncome_2Q = ['-','-','-','-','-'];
	let operatingIncome_3Q = [173,'-','-','-','-'];
	let operatingIncome_4Q = [241,157,69,-17,42];
// 経常利益
	let ordinaryIncome_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let ordinaryIncome_1Q = ['-','-','-','-','-'];
	let ordinaryIncome_2Q = ['-','-','-','-','-'];
	let ordinaryIncome_3Q = [174,'-','-','-','-'];
	let ordinaryIncome_4Q = [246,153,64,-23,38];
// 当期純利益
	let currentNetIncome_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let currentNetIncome_1Q = ['-','-','-','-','-'];
	let currentNetIncome_2Q = ['-','-','-','-','-'];
	let currentNetIncome_3Q = [115,'-','-','-','-'];
	let currentNetIncome_4Q = [150,94,24,-10,22];
// 1株当たり当期純利益(円)
	let currentNetIncomePerStock_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let currentNetIncomePerStock_1Q = ['-','-','-','-','-'];
	let currentNetIncomePerStock_2Q = ['-','-','-','-','-'];
	let currentNetIncomePerStock_3Q = [48.64,'-','-','-','-'];
	let currentNetIncomePerStock_4Q = [63.07,41.53,10.57,-4.52,9.81];
// 自己資本当期純利益率/ROE(%)
	let roe_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let roe_1Q = ['-','-','-','-','-'];
	let roe_2Q = ['-','-','-','-','-'];
	let roe_3Q = ['-','-','-','-','-'];
	let roe_4Q = [35.1,49.7,24.6,-11.5,26.6];
// 総資産
	let totalAssets_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let totalAssets_1Q = ['-','-','-','-','-'];
	let totalAssets_2Q = ['-','-','-','-','-'];
	let totalAssets_3Q = [1184,'-','-','-','-'];
	let totalAssets_4Q = [1242,919,743,595,388];
// 純資産
	let netAssets_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let netAssets_1Q = ['-','-','-','-','-'];
	let netAssets_2Q = ['-','-','-','-','-'];
	let netAssets_3Q = [553,'-','-','-','-'];
	let netAssets_4Q = [589,268,113,86,96];
// 自己資本比率
	let capitalRatio_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let capitalRatio_1Q = ['-','-','-','-','-'];
	let capitalRatio_2Q = ['-','-','-','-','-'];
	let capitalRatio_3Q = [46.7,'-','-','-','-'];
	let capitalRatio_4Q = [47.5,29.3,15.3,14.5,24.9];
// 1株当たり純資産額(円)
	let totalAssetsPerStock_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let totalAssetsPerStock_1Q = ['-','-','-','-','-'];
	let totalAssetsPerStock_2Q = ['-','-','-','-','-'];
	let totalAssetsPerStock_3Q = ['-','-','-','-','-'];
	let totalAssetsPerStock_4Q = [239.15,113.74,50.36,37.17,41.73];
// 営業活動によるキャッシュフロー
	let operatingCashFlow_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let operatingCashFlow_1Q = ['-','-','-','-','-'];
	let operatingCashFlow_2Q = ['-','-','-','-','-'];
	let operatingCashFlow_3Q = ['-','-','-','-','-'];
	let operatingCashFlow_4Q = ['-',21,171,'-','-'];
// 投資活動によるキャッシュフロー
	let investmentCashFlow_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let investmentCashFlow_1Q = ['-','-','-','-','-'];
	let investmentCashFlow_2Q = ['-','-','-','-','-'];
	let investmentCashFlow_3Q = ['-','-','-','-','-'];
	let investmentCashFlow_4Q = ['-',-147,-74,'-','-'];
// 財務活動によるキャッシュフロー
	let financialCashFlow_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let financialCashFlow_1Q = ['-','-','-','-','-'];
	let financialCashFlow_2Q = ['-','-','-','-','-'];
	let financialCashFlow_3Q = ['-','-','-','-','-'];
	let financialCashFlow_4Q = ['-',7,60,'-','-'];
// 現金及び現金同等物の期末残高
	let remainingSum_ym = ['2017/12','2016/12' ,'2015/12' ,'2014/12' ,'2013/12' ];
	let remainingSum_1Q = ['-','-','-','-','-'];
	let remainingSum_2Q = ['-','-','-','-','-'];
	let remainingSum_3Q = ['-','-','-','-','-'];
	let remainingSum_4Q = ['-',223,340,'-','-'];
...
// *****************************************************************************
function print_elec_notice(pageNo, pageSize, charset, datestyle, order, menuName, year){
	...
	if(data.info == '該当する内容はありません。'){
		...
		if(
			...
			if(data.items.length>0){
				let i = 0;
				let ct = 0;
				str = str + '<ul class="rss-antenna">';
				for (i = 0; i < lct; i++){			// 繰り返し表示
				    if(data.items[i]['haveContent'] === true){
				    	ct++;
						str = str + '<li class="rss-item">';
						str = str + '<a href=' + data.items[i]['pdf'] + ' target="_blank">';
						str = str + '<p class="category">PDF</p>';
						str = str + '<p class="date">' + data.items[i]['publishDate'].substr(-5) + '</p>';
				...
				str = str + '</ul>';
				if(i==0){
					str = '<p class="leadL pb50">掲載情報がありません。</p>';
				}
				$('#script_out').html(str);
			}else{
				str = '<p class="leadL pb50">掲載情報がありません。</p>';
...
//		<div id="script_out"></div>
// *****************************************************************************
function print_message(pageNo, pageSize, charset, datestyle, order, menuName, year){
...
function print_irnewsMenu() {
	...
	if(type_value == '0'){
		str = str + '<a href="' + '?yr=' + yr_val + '&tp=0' + '" class="select">すべて</a>';
	}else{
		str = str + '<a href="' + '?yr=' + yr_val + '&tp=0' + '">すべて</a>';
	}
	if(type_value == '1'){
	...
	if(type_value == '5'){
		str = str + '<a href="' + '?yr=' + yr_val + '&tp=5' + '" class="select">適時開示</a>';
	}else{
		str = str + '<a href="' + '?yr=' + yr_val + '&tp=5' + '">適時開示</a>';
	}
	if(type_value == '6'){
		str = str + '<a href="' + '?yr=' + yr_val + '&tp=6' + '" class="select">その他資料</a>';
	}else{
		str = str + '<a href="' + '?yr=' + yr_val + '&tp=6' + '">その他資料</a>';
	}
...
.done(function(data){
	...
	if(max_itemcount>0){
	    if(data.items.length){
			items = items + '<div class="yearnavi">';
			items = items + '<form action="#" method="GET" name="Form_yearnavi">';
			items = items + '<select name="yearnavi_chg" onChange="yearnavi_send()">';
...
// 年度セレクト数
		...
		items = items + '<ul class="rss-antenna">';
	    if(data.items.length){
			for (let i = 0; i < lct; i++){			// 繰り返し表示
				...
				items = items + '<li class="rss-item">';
				if(data.items[i]['pdf'] !== ''){
					items = items + '<a href=' + data.items[i]['pdf'] + ' target="_blank">';
				}
				items = items + '<p class="category">' + ircate_icon +'</p><p class="date">' + data.items[i]['publishDate'] + '</p>';
				items = items + '<p class="title">' + data.items[i]['title'];
				//items = items + '<i>PDF</i>';
				items = items + '</p>';
				if(data.items[i]['pdf'] !== ''){
					items = items + '</a>';
		...
		items = '<p class="leadL pb50">掲載情報がありません。</p>';
	}
	
	$('#script_out').html(items);				// 出力
	$('#fadeIn_content').hide();
	if(year_select_all == 0){
...
// 年度セレクト数
	    ...
	    if(data.items.length){
			for (let i = 0; i < lct; i++){			// 繰り返し表示
				...
				items = items + '<p class="category">' + '有報' + '</p><p class="date">' + data.items[i]['publishDate'] + '</p>';
				items = items + '<p class="title">' + data.items[i]['title'];
				//items = items + '<i>PDF</i>';
				items = items + '</p>';
				if(data.items[i]['pdf'] !== ''){
...
//		<div id="script_out"></div>
// *****************************************************************************
// new script load for design wagokoro 2021

function print_whatsNewDesign2021(script_out_id, pageNo, pageSize, charset, datestyle, order, category, categorySub, year, year_select_count, year_select_all){
...
// 年度セレクト数
        ...
        .fail(function(data){
            $('#'+ script_out_id).html('<p class="leadL pb50">掲載情報がありません。</p>');
        })
        .always(function(data){
...
//		<div id="script_out"></div>
// *****************************************************************************
function print_ircalender(pageNo, pageSize, charset, datestyle, order, menuName, year){
...
// 年を抽出(マージする)
		let ym_str = [];
		let k = 0;
		ym_str[0] = ircalender_data_all[0][3].slice(0,4);
		for(let i=0; i<ircalender_suu; i++){
			if(ym_str[k] != ircalender_data_all[i][3].slice(0,4)){
				k++;
		...
		for(let i=0; i<ym_str.length; i++){
			str = str + '<h3>' + ym_str[i].slice(0,4) + '年</h3>';
			str = str + '<div class="ir_tl">';
			str = str + '<table style="margin-top:0px !important;">';
			for(let k=0; k<ircalender_suu; k++){
				if(ym_str[i] == ircalender_data_all[k][3].slice(0,4)){
					str = str + '<tr>';
					str = str + '<th>' + ircalender_data_all[k][0];
					str = str + '</th>';
					str = str + '<td>';
...
// 年度セレクト数
		...
		items = items + '<ul class="rss-antenna">';
	    if(data.items.length){
			for (let i = 0; i < pageSize; i++){			// 繰り返し表示
				items = items + '<li class="rss-item">';
				if(data.items[i]['pdf'] !== ''){
					items = items + '<a href=' + data.items[i]['pdf'] + ' target="_blank">';
				}
				items = items + '<p class="category">' + data.items[i]['category'] +'</p><p class="date">' + data.items[i]['publishDate'] + '</p>';
				items = items + '<p class="title">' + data.items[i]['title'];
				//items = items + '<i>PDF</i>';
				items = items + '</p>';
				if(data.items[i]['pdf'] !== ''){
...
// 連結データの取得
	...
	let url_t = url_all_t + '&datanumber=' + datanumber + '&order=year_quarter_desc';
	let data_yn_suu;
	let i = 0;
	let j_ym = [];
	let j_value = [];
...
.done(function(data){
	...
	if(data_yn_suu>0){			// 通期データがある場合
		for(i = 0; i < data_yn_suu; i++){
			j_ym[i] = data.items[i]['year'].slice(0,4) + '/' + data.items[i]['month'].slice(0,2);
...
function pr_salesAmount(datanumber, param, j_data_cons_ym, j_data_cons_value){
	...
	let j = 0;
	let k = 0;
	let url_4 = url_all_4 + '&datanumber=' + datanumber + '&order=year_quarter_desc';
	let url_t = url_all_t + '&datanumber=' + datanumber + '&order=year_quarter_desc';

	let chart_element = 'Chart01';
	let chart_type = 'bar';

	let data_ym = [];	let data_1q = [];	let data_2q = [];	let data_3q = [];	let data_4q = [];
	let j_data_ym = [];	let j_data_1q = [];	let j_data_2q = [];	let j_data_3q = [];	let j_data_4q = [];
	let mg_data_ym = [];	let mg_data_1q = [];	let mg_data_2q = [];	let mg_data_3q = [];	let mg_data_4q = [];
	let data_yn_suu = 0;
	let j_data_yn_suu = 0;
	let j_ret_data1;
	let j_ret_data = [];
...
// デフォルト変数の精査(数値が格納されているかどうか)
	...
	if(flg == true){		// データが格納されている
// デフォルト変数の精査
		data_yn_suu = salesAmount_ym.length;
		for(i=0; i < 5; i++){
			if(salesAmount_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = salesAmount_ym[i].slice(salesAmount_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = salesAmount_ym[i].slice(0, salesAmount_ym[i].indexOf('/'));
...
// APIデータの確認
	...
	if(max_itemcount > 0){
		k = 0;
		j_ret_data[k] = data.items[k]['year'].slice(0,4) + '/' + data.items[k]['month'].slice(0,2); // 最新の年号
		for(i = 0; i < max_itemcount; i++){
			j_ret_data1 = data.items[i]['year'].slice(0,4) + '/' + data.items[i]['month'].slice(0,2);
		...
		for(i = 0; i < max_itemcount; i++){
			...
			let iti = j_ret_data.indexOf(data.items[i]['year'].slice(0,4) + '/' + data.items[i]['month'].slice(0,2));
			switch(qt){
				case '1Q':
					j_data_1q[iti] = vl;
					break;
...
// データのマージ
	let dd_ym = [];	let dd_1q = [];	let dd_2q = [];	let dd_3q = [];	let dd_4q = [];
	if(j_data_yn_suu == 0){		// APIデータがない場合(defaultを使用する）
		for(i=0;i<5;i++){
			if(data_ym[i] != '-'){
...
// 連結データの検査
	if(j_data_cons_ym.length){
		for(i = 0; i < j_data_cons_ym.length; i++){
			...
			if(ii != -1){	// 連結データを代入する年月があれば
				mg_data_4q[ii] = j_data_cons_value[i];
			}
			else{			// 連結データがない場合 かつ 取込データが最新ならば
	...
	for(i=0;i<5;i++){
		if(G_salesAmount_ym[i] != undefined){
			if(G_salesAmount_1Q[i] != '-'){
				dat = String(G_salesAmount_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_salesAmount_2Q[i] != '-'){
				dat = String(G_salesAmount_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_salesAmount_3Q[i] != '-'){
				dat = String(G_salesAmount_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_salesAmount_4Q[i] != '-'){
				dat = String(G_salesAmount_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
    ...
    data: {
        ...
        datasets: [
          ...
          },
		  {
              ...
              label: "通期",
              //背景色
              backgroundColor: "rgba(195,13,35,0.9)",
              //枠線の色
              borderColor: "rgba(195,13,35,1)",
              //枠線の太さ
              borderWidth: 0.5,
              //背景色（ホバーしたときに）
              hoverBackgroundColor: "rgba(255,255,255,1)",
              //枠線の色（ホバーしたときに）
              hoverBorderColor: "rgba(195,13,35,1)",
              //グラフのデータ
	...
	tooltips: {
        callbacks: {
            label: function(tooltipItem, data){
                return tooltipItem.yLabel.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',') +' 百万円';
            }
        }
    },
	scales: {
...
//		グラフ
// *****************************************************************************
function pr_operatingIncome(datanumber, param, j_data_cons_ym, j_data_cons_value){
	let pageSize = 100;
	let sa_yr_val = new Array();
	let ret_data = new Array();
	let ret_data1 = "";
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(operatingIncome_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = operatingIncome_ym[i].slice(operatingIncome_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = operatingIncome_ym[i].slice(0, operatingIncome_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_operatingIncome_ym[i] != undefined){
			if(G_operatingIncome_1Q[i] != '-'){
				dat = String(G_operatingIncome_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_operatingIncome_2Q[i] != '-'){
				dat = String(G_operatingIncome_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_operatingIncome_3Q[i] != '-'){
				dat = String(G_operatingIncome_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_operatingIncome_4Q[i] != '-'){
				dat = String(G_operatingIncome_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
//		グラフ
// *****************************************************************************
function pr_ordinaryIncome(datanumber, param, j_data_cons_ym, j_data_cons_value){
	let pageSize = 100;
	let sa_yr_val = new Array();
	let ret_data = new Array();
	let ret_data1 = "";
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(ordinaryIncome_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = ordinaryIncome_ym[i].slice(ordinaryIncome_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = ordinaryIncome_ym[i].slice(0, ordinaryIncome_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_ordinaryIncome_ym[i] != undefined){
			if(G_ordinaryIncome_1Q[i] != '-'){
				dat = String(G_ordinaryIncome_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_ordinaryIncome_2Q[i] != '-'){
				dat = String(G_ordinaryIncome_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_ordinaryIncome_3Q[i] != '-'){
				dat = String(G_ordinaryIncome_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_ordinaryIncome_4Q[i] != '-'){
				dat = String(G_ordinaryIncome_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
//		グラフ
// *****************************************************************************
function pr_currentNetIncome(datanumber, param, j_data_cons_ym, j_data_cons_value){
	let pageSize = 100;
	let sa_yr_val = new Array();
	let ret_data = new Array();
	let ret_data1 = "";
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(currentNetIncome_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = currentNetIncome_ym[i].slice(currentNetIncome_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = currentNetIncome_ym[i].slice(0, currentNetIncome_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_currentNetIncome_ym[i] != undefined){
			if(G_currentNetIncome_1Q[i] != '-'){
				dat = String(G_currentNetIncome_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_currentNetIncome_2Q[i] != '-'){
				dat = String(G_currentNetIncome_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_currentNetIncome_3Q[i] != '-'){
				dat = String(G_currentNetIncome_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_currentNetIncome_4Q[i] != '-'){
				dat = String(G_currentNetIncome_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
// グラフ表示
	pr_currentNetIncomePerStock(datanumber, param, j_data_cons_ym, j_data_cons_value);
	return true;
})
.fail(function(data){
	return false;
...
//		グラフ
// *****************************************************************************
function pr_currentNetIncomePerStock(datanumber, param, j_data_cons_ym, j_data_cons_value){
	let pageSize = 100;
	let sa_yr_val = new Array();
	let ret_data = new Array();
	let ret_data1 = "";
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(currentNetIncomePerStock_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = currentNetIncomePerStock_ym[i].slice(currentNetIncomePerStock_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = currentNetIncomePerStock_ym[i].slice(0, currentNetIncomePerStock_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_currentNetIncomePerStock_ym[i] != undefined){
			if(G_currentNetIncomePerStock_1Q[i] != '-'){
				dat = String(G_currentNetIncomePerStock_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_currentNetIncomePerStock_2Q[i] != '-'){
				dat = String(G_currentNetIncomePerStock_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_currentNetIncomePerStock_3Q[i] != '-'){
				dat = String(G_currentNetIncomePerStock_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_currentNetIncomePerStock_4Q[i] != '-'){
				dat = String(G_currentNetIncomePerStock_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
// 各クォーター・年度の値を表示
	...
	for(i=0;i<5;i++){
		if(G_roe_ym[i] != undefined){
			if(G_roe_1Q[i] != '-'){
				dat = String(G_roe_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_roe_2Q[i] != '-'){
				dat = String(G_roe_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_roe_3Q[i] != '-'){
				dat = String(G_roe_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_roe_4Q[i] != '-'){
				dat = String(G_roe_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
    ...
    data: {
        ...
        datasets: [
          ...
          },
		  {
              ...
              borderWidth: 1.5,
              //背景色（ホバーしたときに）
              hoverBackgroundColor: "rgba(235,97,0,0)",
              //枠線の色（ホバーしたときに）
              hoverBorderColor: "rgba(195,13,35,1)",
              //グラフのデータ
			  data: G_roe_4Q
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(totalAssets_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = totalAssets_ym[i].slice(totalAssets_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = totalAssets_ym[i].slice(0, totalAssets_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_totalAssets_ym[i] != undefined){
			if(G_totalAssets_1Q[i] != '-'){
				dat = String(G_totalAssets_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_totalAssets_2Q[i] != '-'){
				dat = String(G_totalAssets_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_totalAssets_3Q[i] != '-'){
				dat = String(G_totalAssets_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_totalAssets_4Q[i] != '-'){
				dat = String(G_totalAssets_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
// 各クォーター・年度の値を表示
	...
	for(i=0;i<5;i++){
		if(G_netAssets_ym[i] != undefined){
			if(G_netAssets_1Q[i] != '-'){
				dat = String(G_netAssets_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_netAssets_2Q[i] != '-'){
				dat = String(G_netAssets_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_netAssets_3Q[i] != '-'){
				dat = String(G_netAssets_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_netAssets_4Q[i] != '-'){
				dat = String(G_netAssets_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(capitalRatio_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = capitalRatio_ym[i].slice(capitalRatio_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = capitalRatio_ym[i].slice(0, capitalRatio_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_capitalRatio_ym[i] != undefined){
			if(G_capitalRatio_1Q[i] != '-'){
				dat = String(G_capitalRatio_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_capitalRatio_2Q[i] != '-'){
				dat = String(G_capitalRatio_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_capitalRatio_3Q[i] != '-'){
				dat = String(G_capitalRatio_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_capitalRatio_4Q[i] != '-'){
				dat = String(G_capitalRatio_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
// グラフ表示
	pr_totalAssetsPerStock(datanumber, param, j_data_cons_ym, j_data_cons_value);
	return true;
})
.fail(function(data){
	return false;
...
//		グラフ
// *****************************************************************************
function pr_totalAssetsPerStock(datanumber, param, j_data_cons_ym, j_data_cons_value){
	let pageSize = 100;
	let sa_yr_val = new Array();
	let ret_data = new Array();
	let ret_data1 = "";
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(totalAssetsPerStock_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = totalAssetsPerStock_ym[i].slice(totalAssetsPerStock_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = totalAssetsPerStock_ym[i].slice(0, totalAssetsPerStock_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_totalAssetsPerStock_ym[i] != undefined){
			if(G_totalAssetsPerStock_1Q[i] != '-'){
				dat = String(G_totalAssetsPerStock_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_totalAssetsPerStock_2Q[i] != '-'){
				dat = String(G_totalAssetsPerStock_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_totalAssetsPerStock_3Q[i] != '-'){
				dat = String(G_totalAssetsPerStock_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_totalAssetsPerStock_4Q[i] != '-'){
				dat = String(G_totalAssetsPerStock_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
// グラフ表示
	pr_operatingCashFlow(datanumber, param, j_data_cons_ym, j_data_cons_value);
	return true;
})
.fail(function(data){
	return false;
...
//		グラフ
// *****************************************************************************
function pr_operatingCashFlow(datanumber, param, j_data_cons_ym, j_data_cons_value){
	let pageSize = 100;
	let sa_yr_val = new Array();
	let ret_data = new Array();
	let ret_data1 = "";
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(operatingCashFlow_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = operatingCashFlow_ym[i].slice(operatingCashFlow_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = operatingCashFlow_ym[i].slice(0, operatingCashFlow_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_operatingCashFlow_ym[i] != undefined){
			if(G_operatingCashFlow_1Q[i] != '-'){
				dat = String(G_operatingCashFlow_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_operatingCashFlow_2Q[i] != '-'){
				dat = String(G_operatingCashFlow_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_operatingCashFlow_3Q[i] != '-'){
				dat = String(G_operatingCashFlow_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_operatingCashFlow_4Q[i] != '-'){
				dat = String(G_operatingCashFlow_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
// グラフ表示
	pr_investmentCashFlow(datanumber, param, j_data_cons_ym, j_data_cons_value);
	return true;
})
.fail(function(data){
	return false;
...
//		グラフ
// *****************************************************************************
function pr_investmentCashFlow(datanumber, param, j_data_cons_ym, j_data_cons_value){
	let pageSize = 100;
	let sa_yr_val = new Array();
	let ret_data = new Array();
	let ret_data1 = "";
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(investmentCashFlow_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = investmentCashFlow_ym[i].slice(investmentCashFlow_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = investmentCashFlow_ym[i].slice(0, investmentCashFlow_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_investmentCashFlow_ym[i] != undefined){
			if(G_investmentCashFlow_1Q[i] != '-'){
				dat = String(G_investmentCashFlow_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_investmentCashFlow_2Q[i] != '-'){
				dat = String(G_investmentCashFlow_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_investmentCashFlow_3Q[i] != '-'){
				dat = String(G_investmentCashFlow_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_investmentCashFlow_4Q[i] != '-'){
				dat = String(G_investmentCashFlow_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
// グラフ表示
	pr_financialCashFlow(datanumber, param, j_data_cons_ym, j_data_cons_value);
	return true;
})
.fail(function(data){
	return false;
...
//		グラフ
// *****************************************************************************
function pr_financialCashFlow(datanumber, param, j_data_cons_ym, j_data_cons_value){
	let pageSize = 100;
	let sa_yr_val = new Array();
	let ret_data = new Array();
	let ret_data1 = "";
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(financialCashFlow_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = financialCashFlow_ym[i].slice(financialCashFlow_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = financialCashFlow_ym[i].slice(0, financialCashFlow_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_financialCashFlow_ym[i] != undefined){
			if(G_financialCashFlow_1Q[i] != '-'){
				dat = String(G_financialCashFlow_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_financialCashFlow_2Q[i] != '-'){
				dat = String(G_financialCashFlow_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_financialCashFlow_3Q[i] != '-'){
				dat = String(G_financialCashFlow_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_financialCashFlow_4Q[i] != '-'){
				dat = String(G_financialCashFlow_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
...
// デフォルト変数の精査
		...
		for(i=0; i < 5; i++){
			if(remainingSum_ym[i] != undefined){
				// 年月をYYYY/MMにそろえる
				let pram = remainingSum_ym[i].slice(remainingSum_ym[i].indexOf('/') + 1);
				let month = ('0' + (pram)).slice(-2);
				let year = remainingSum_ym[i].slice(0, remainingSum_ym[i].indexOf('/'));
				data_ym[i] = year + '/' + month;
			}else{
				data_ym[i] = '-';
			}	
	...
	for(i=0;i<5;i++){
		if(G_remainingSum_ym[i] != undefined){
			if(G_remainingSum_1Q[i] != '-'){
				dat = String(G_remainingSum_1Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_1Q').html(dat);
			if(G_remainingSum_2Q[i] != '-'){
				dat = String(G_remainingSum_2Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_2Q').html(dat);
			if(G_remainingSum_3Q[i] != '-'){
				dat = String(G_remainingSum_3Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_3Q').html(dat);
			if(G_remainingSum_4Q[i] != '-'){
				dat = String(G_remainingSum_4Q[i]).replace( /(\d)(?=(\d\d\d)+(?!\d))/g, '$1,' );
			}else{
				dat = '-';
			}
			$('#' + param + '_' + String(j) + '_4Q').html(dat);
