...
(function ($) {
  ...
  (function () {
    ...
    /*========================================================
     コンストラクタ
    ========================================================*/
    XjStorageLoaderIrTopGov = function (s) {
      /*var defaults = {
    ...
    this.ary_doc_Info;
      ...
      XjStorageLoaderIrTopGov.prototype.init.call(this);
    };

    /*========================================================
     初期設定
    ========================================================*/
    XjStorageLoaderIrTopGov.prototype.init = function () {
      $.ajaxSetup({
    ...
    /*========================================================
     表示処理
    ========================================================*/
    XjStorageLoaderIrTopGov.prototype.show = function () {
  ...
  $(function () {
    var xj_storage_loader_gov = new XjStorageLoaderIrTopGov();
	  console.log(xj_storage_loader_gov);
  });
})(jQuery);
