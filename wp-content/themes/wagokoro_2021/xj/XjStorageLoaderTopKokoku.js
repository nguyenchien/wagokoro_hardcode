    ...
    $.getJSON(url,
      function (data) {
        ...
        if (data.items) {
          ...
          cont += '<li class="rss-item no-data">ただいま掲載すべき公告事項はございません。</li>';

        }

        $('#xj-mainlist-kokoku').append(cont);
      });
  }
...
$(function () {
  var xj_storage_loader_kokoku = new XjStorageLoaderKokoku();
});
