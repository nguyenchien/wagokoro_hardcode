...
(function () {
  ...
  /*========================================================
   コンストラクタ
  ========================================================*/
  XjStorageLoaderTopLib = function (s) {
    var defaults = {
    ...
    XjStorageLoaderTopLib.prototype.init.call(this);
  };

  /*========================================================
   初期設定
  ========================================================*/
  XjStorageLoaderTopLib.prototype.init = function () {
    $.ajaxSetup({
      scriptCharset: 'utf-8'
    });
  ...
  /*========================================================
   年選択ボタン生成
  ========================================================*/
  XjStorageLoaderTopLib.prototype.setMaxMinYear = function (code) {
    var self = this;
    var xjurl = '';
  ...
  /*========================================================
   年選択ボタン生成
  ========================================================*/
  XjStorageLoaderTopLib.prototype.setDateButton = function () {
    var self = this;
  ...
  /*========================================================
   カテゴリー選択ボタン生成
  ========================================================*/
  XjStorageLoaderTopLib.prototype.setDocumentButton = function () {
    var self = this;
  ...
  /*========================================================
   絞込み期間更新
  ========================================================*/
  XjStorageLoaderTopLib.prototype.setDuration = function (f, p) {
    this.fdate = f;
    this.pdate = p;
    this.show();
  }
  ...
  /*========================================================
   絞込みカテゴリー更新
  ========================================================*/
  XjStorageLoaderTopLib.prototype.setDocument = function (d) {
    this.documents = d;
    this.show();
  }
  ...
  /*========================================================
   表示処理
  ========================================================*/
  XjStorageLoaderTopLib.prototype.show = function () {
    var self = this;
    var is_first = true;
...
$(function () {
  var xj_storage_loader_top_lib = new XjStorageLoaderTopLib();
});
